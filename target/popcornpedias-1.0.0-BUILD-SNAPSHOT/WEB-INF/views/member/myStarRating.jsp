		...
		<ul class="list-unstyled row p-5 set-width">
			    ...
			    <li class="mb-4 starRatingList col-md-2" data-movie_id="${starRating.movie_id }" >
			      <div class="card no-border cursor-p" onclick="redirectToLink(this)">
			        ...
			        <div class="card-body">
			          ...
			          <div  id="starRatingContainer" class="d-flex" >
				          	<span class="star">
				            ★★★★★
				            <span class="text-nowrap" id="spanstar">★★★★★</span>  
				            <input type="number" id="starRating" name="starRating" value="${starRating.rating }" step="0.5" min="0" max="5"/>
				            <input type="hidden" id="updateStarRatingForm">
				          	</span>
			          		 <span class="ms-2">${starRating.rating }</span>
			          </div>
			        </div>
			      </div>
			    </li>
			...
			<div class="border-bottom mt-2 mb-3" ></div>
			  	<div class="emptyReviewBox text-center " style="min-height:60vh;">	
			  		<p class="align-middle" style="display:inline-block; line-height: 60vh; -webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none; font-size:17px;"> 작성된 별점이 없습니다. </p>	
			  	</div>
